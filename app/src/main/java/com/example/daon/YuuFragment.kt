...
class YuuFragment : Fragment(), OnItemClickListener {
    private lateinit var preferenceUtil: PreferenceUtil
    private var _binding: FragmentYuuBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentYuuBinding.inflate(inflater, container, false)

        recyclerView = binding.yeeRv
        recyclerView.layoutManager = LinearLayoutManager(requireContext())

        preferenceUtil = PreferenceUtil(requireContext())
        val isFavorite = preferenceUtil.getFavoriteState(R.id.item6)
        ...
        binding.fab01.setOnClickListener {
            activity?.let{
                ...
                intent.putExtra("boardType", "breast")
