...
import com.example.daon.conect.authorization.EmailCodeListCallRequestDto
import com.example.daon.conect.authorization.EmailCodeListCallResponseDto
...
import com.example.daon.conect.user.VerificationResponseDto
...
class JoinFragment : Fragment() {
    ...
    private lateinit var joinLayout: ConstraintLayout
    ...
    override fun onCreateView(
        ...
        emailEditText = view.findViewById(R.id.join_email_et)
        nextButton = view.findViewById(R.id.join_next_btn)
        joinLayout = view.findViewById(R.id.fragment_join)
        endText = view.findViewById(R.id.end_text)
        certifyButton = view.findViewById(R.id.join_certify_btn)
        secretEditText = view.findViewById(R.id.join_secret_et)
        ...
        checkEditText = view.findViewById(R.id.join_check_et)
        noSameImageView = view.findViewById(R.id.no_same)
        certifyNumEditText = view.findViewById(R.id.join_certify_num_et)
    ...
    emailEditText.addTextChangedListener(object : TextWatcher {
        ...
        certifyButton.setOnClickListener {
            if (isValidEmail(emailEditText.text.toString())) {
                ...
                certifyButton.setImageResource(R.drawable.done_certify)
        ...
        certifyNumButton.setOnClickListener {
            ...
            val emailCodeCheckRequest = EmailCodeCheckRequestDto(
                ...
                queryEmail = emailEditText.text.toString())
                ...
                override fun onResponse(call: Call<EmailCodeCheckResponseDto>, response: Response<EmailCodeCheckResponseDto>) {
                    if (response.isSuccessful) {
                        ...
                        if (emailCodeCheckResponse?.isSuccess == true) {
                            // 인증번호가 일치하는 경우
                            certifyNumImageView.visibility = View.VISIBLE
                            certifyNotImageView.visibility = View.INVISIBLE
                            ...
                            // 인증번호가 일치하지 않는 경우
                            certifyNumImageView.visibility = View.INVISIBLE
                            certifyNotImageView.visibility = View.VISIBLE
                            certifyNumEditText.backgroundTintList =
        ...
        secretEditText.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(editable: Editable?) {
                if (certifyNumImageView.visibility != View.VISIBLE) {
    ...
    private fun updateNextButtonState() {
        ...
        val isNumValid = (certifyNumImageView.visibility == View.VISIBLE)
        ...
        nextButton.setOnClickListener {
            if (nextButton.isEnabled) {
                ...
                val signUpRequest = SignUpRequestDto(
                    user_name = "",
                    email = "",
                    password = secretEditText.text.toString(), // 비밀번호
                    phone_number = "",
                    birth_date = "",
                    gender = 0,
                    user_nickname = "",
                ...
                val transaction = requireActivity().supportFragmentManager.beginTransaction()
                transaction.replace(R.id.fragment_join, selfCertifyFragment)
                transaction.addToBackStack(null)
                transaction.commit()
            }
        }
