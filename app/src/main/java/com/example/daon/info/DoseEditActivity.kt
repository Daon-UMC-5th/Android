...
import com.example.daon.databinding.ActivityDoseEditBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class DoseEditActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDoseEditBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDoseEditBinding.inflate(layoutInflater)
    ...
    private fun editInfo(){
        val doseListInsertRequestDto = DoseListInsertRequestDto(
            ...
            alarm_days = binding.day.text.toString()
        )
        val call = ApiClient.calendarService.doseListEdit(jwt,data.medicationId,doseListInsertRequestDto)
    ...
    private fun initInfo(){
        ...
        binding.medicine.setText(data.medicine)
